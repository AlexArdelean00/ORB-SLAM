...
evo_traj tum "Exp1_GT.tum" "Exp1_ORB.tum" --plot --plot_mode xy --ros_map_yaml "../map_gt_A/corridor_A.yaml"
...
evo_traj tum "Exp1_GT.tum" "aligned_Exp1_ORB.tum" --plot --plot_mode xy --ros_map_yaml "../map_gt_A/corridor_A.yaml"
